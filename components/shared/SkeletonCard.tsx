...
export function SkeletonAssetCard() {
  return (
    <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#121826] p-4 space-y-3">
      <div className="flex items-center gap-2">
        <Skeleton className="h-5 w-10 rounded bg-[rgba(255,255,255,0.06)]" />
        <Skeleton className="h-5 w-14 rounded bg-[rgba(255,255,255,0.06)]" />
      </div>
...
export function SkeletonQuestRow() {
  return (
    <div className="flex items-center gap-4 px-4 py-3 border-b border-[rgba(255,255,255,0.04)]">
      ...
      <Skeleton className="h-4 w-24 bg-[rgba(255,255,255,0.04)]" />
      <Skeleton className="h-4 w-24 bg-[rgba(255,255,255,0.04)]" />
    </div>
  );
}
...
export function SkeletonQuestCard() {
  return (
    <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#121826] p-4 space-y-3">
      ...
      <Skeleton className="h-5 w-3/4 bg-[rgba(255,255,255,0.07)]" />
      <Skeleton className="h-3 w-full bg-[rgba(255,255,255,0.04)]" />
      <Skeleton className="h-3 w-2/3 bg-[rgba(255,255,255,0.04)]" />
