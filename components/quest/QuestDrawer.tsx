      ...
      {isQuestDrawerOpen && activeQuest && (
        <>
          ...
          >
            {/* Header */}
            <div
              className="flex items-start justify-between p-5 border-b border-[rgba(255,255,255,0.06)]"
              style={{
                background: 'linear-gradient(135deg, rgba(255,0,212,0.04), rgba(161,0,255,0.04))',
              }}
            >
              <div className="flex-1 min-w-0 me-3">
                ...
                <h2 className="text-[#F3F4F6] font-semibold text-lg leading-snug">{title}</h2>
              </div>
              <button
                ref={closeRef}
                onClick={closeQuestDrawer}
                className="p-1.5 rounded-lg text-[#6B7280] hover:text-[#F3F4F6] hover:bg-[rgba(255,255,255,0.05)] transition-colors shrink-0"
            ...
            {/* Meta */}
            <div className="px-5 py-3 border-b border-[rgba(255,255,255,0.04)] flex flex-wrap gap-4 text-xs text-[#6B7280]">
